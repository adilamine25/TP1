    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (currentCommand) {
                case CREATE_STUDENT: {
                    System.out.println("Veuillez entrer les informations de l'étudiant au format : fistName,lastName,age,gender(MALE|FEMALE),cin");
                    String[] studentArgs = scanner.nextLine().split(",");
                    students.add((Student) personService.createStudent(studentArgs[0], studentArgs[1], Integer.valueOf(studentArgs[2]), Gender.valueOf(studentArgs[3]), studentArgs[4]));
                    break;
                }
                case SHOW_STUDENTS: {
